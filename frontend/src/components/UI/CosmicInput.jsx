...
const CosmicInput = ({ value, onChange, onSend, placeholder = "Type a message..." }) => {
            ...
            <div style={{ width: '100%' }}>
                <div id="search-container">
                    ...
                    <div id="main">
                        ...
                        <button id="wormhole-icon" onClick={onSend} type="button">
                            <Send size={20} color="#a9c7ff" />
                        </button>
                    </div>
                </div>
            </div>
...
const StyledWrapper = styled.div`
  ...
  .nebula {
    ...
    position: absolute;
    overflow: hidden;
    z-index: 0; /* Adjusted z-index to sit behind input */
    border-radius: 12px;
    filter: blur(3px);
  }
  ...
  .input {
    ...
    border-radius: 10px;
    color: #a9c7ff;
    padding-left: 20px; /* Reduced padding since search icon is gone */
  ...
  /* Inner elements with fluid widths */
  .stardust {
    max-height: 63px;
    max-width: 98%;
    border-radius: 10px;
  ...
  #wormhole-icon:hover {
    ...
    background: linear-gradient(180deg, #2a3875, #05071b, #1c2452);
  }
  
  #wormhole-icon:active {
